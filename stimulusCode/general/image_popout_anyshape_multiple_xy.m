function [I,xcent,ycent, xfound, yfound]=image_popout_anyshape_multiple_xy(gridsize,len,wid,spacing,angle,contrast,backgnd,jitter_pos,jitter_ang,surr_prob,shape_cell,acent,bcent,sconj,xfound,yfound)
...
for x=xlocations
  ...
  for y=ylocations
    ...
    if a==acent && b==bcent
      I=draw_bar(I,xval,yval,bar1,angle(1),contrast(1),backgnd);
      xcent=xval;
      ycent=yval;
    else
