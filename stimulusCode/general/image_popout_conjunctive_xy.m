function [I,xcent,ycent,xfound,yfound]=image_popout_conjunctive_xy(gridsize,len,wid,spacing,angle,contrast,backgnd,jitter_pos,jitter_ang,surr_prob,conj_prob,acent,bcent,rconj,sconj,xfound,yfound)
