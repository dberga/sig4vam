...
for ibeta=1:length(beta)
    for irms=1:length(RMS)
        ...
        outdir=fullfile('exp1a_Varug',['Beta_',num2str(beta(ibeta)),'RMS_',num2str(RMS(irms))]);
        ...
        imwrite(R, fullfile(outdir,'out.png'));
        imwrite(mask, fullfile(outdir,'mask.png'));
