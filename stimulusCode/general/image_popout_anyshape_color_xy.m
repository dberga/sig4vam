function [I,xcent,ycent,xfound,yfound]=image_popout_anyshape_color_xy(gridsize,len,wid,spacing,angle,contrast,backgnd,jitter_pos,jitter_ang,surr_prob,Ishape,acent,bcent,sconj,xfound,yfound)
...
for c=1:C
I(:,:,c)=zeros(size(I(:,:,1)));
[I(:,:,c),xcent,ycent,xfound,yfound]=image_popout_anyshape_xy(gridsize,len,wid,spacing,angle,contrast(c,:)-backgnd(c,:),backgnd(c,:),jitter_pos,jitter_ang,surr_prob,shape,acent,bcent,sconj,xfound,yfound);
end
end
