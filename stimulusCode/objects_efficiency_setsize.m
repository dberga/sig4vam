function [  ] = objects_efficiency_setsize( evaluation_list )
    ...
    Ishapes_rgb{1}=load_anyshape('stimulusCode/shapes/objects/elephant.png');
    Ishapes_rgb{2}=load_anyshape('stimulusCode/shapes/objects/elephant.png');
    Ishapes{1}=load_anyshape('stimulusCode/shapes/objects/elephant.png',1);
    Ishapes{2}=load_anyshape('stimulusCode/shapes/objects/elephant.png',1);
...
%                                 [~,~,spacing,~]=standard_image_param_values(imsizefac,crop,1);
                                ...
                                [I,ycoord,xcoord]=image_popout_anyshape_xy(gridsize,barlen,barwid,spacing,[0,180],contrast_bw,Ibackground,jitter_pos,jitter_angle,values(v),Ishapes_rgb{1},a,b);
