function [I,xcent,ycent,xfound,yfound]=image_popout_xy(gridsize,len,wid,spacing,angle,contrast,backgnd,jitter_pos,jitter_ang,surr_prob,acent,bcent,sconj,xfound,yfound)
